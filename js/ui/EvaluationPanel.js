class EvaluationPanel {
    ...
    _buildRubricHTML(groupIndex, labels) {
        ...
        html += `<div class="rubric-criteria-grid" style="display:grid; grid-template-columns:repeat(auto-fill,minmax(250px,1fr)); gap:10px;">`;
        this.rubric.criteria.forEach((c, ci) => {
            html += `<div class="rubric-criterion-card" style="background:#f8fafc; border:1px solid #f1f5f9; border-radius:10px; padding:10px;">`;
